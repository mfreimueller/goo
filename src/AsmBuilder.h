...
namespace goo {
    ...
    public:
        ...
        /// Returns the current state of the builder. Note, that this builder is
        /// not meant to be reusable. Having called ::build doesn't reset the internal
        /// state, instead it is recommended to create a new instance.
        ...
        /// Adds a comment to the current line, appending it via a semicolon.
